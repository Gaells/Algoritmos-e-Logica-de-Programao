...
type  								//cria novos tipos de informaçao
     ...
     vetor=array[1..3000] of cc; 	// tipo vetor vetor de 2000 posições com duas informaçoes (integer e string[35]) por posição
     tipo=string[35];      				// tipo tipo 35 caracteres	
     a35=string[35];              // tipo a35 35 caracteres
		 vet1=array[1..3000] of a35;  // tipo vet1 vetor de 2000 posições com uma informação, (string[35]) por posição
